  ...
  return (
    <OutputSurface>
      <OutputSurfaceHeader
        ...
        action={
          hostname ? (
            <span className="inline-flex items-center gap-1 text-micro text-text-subtle">
      ...
      <OutputSurfaceBody>
        ...
        {maxSteps > 0 && (
          <div className="mb-2 flex items-center gap-2">
            <Progress value={progressValue} className="h-1.5 flex-1" indicatorClassName="bg-ring" />
