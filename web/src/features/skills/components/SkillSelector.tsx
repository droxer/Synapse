            ...
            <PopoverTrigger asChild>
              <button
                ...
                className={cn(
                  ...
                  "focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded",
                )}
              >
          ...
          <PopoverTrigger asChild>
            {variant === "shelf" ? (
              ...
              <Button
                ...
                aria-label={t("skills.selector.select")}
                className={cn(
                  "gap-1.5 rounded-lg px-2.5 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground",
            ...
            <div className="border-b border-border/60 px-3 py-2">
              <div className="flex items-center gap-2 rounded-md border border-border bg-background px-2.5 py-1.5">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-xs text-foreground placeholder:text-text-subtle outline-none"
                />
              </div>
            </div>
          )}
